...
This package contains a HTML page + scripts to calculcate beer recipes. The
page is in Dutch, since that's the native language of the author.

The remainder of this document is written in Dutch too.

<remainder lang="nl">

BrewGear is een handig tooltje voor (nederlandssprekende) hobby brouwers. Dit
...
Ik kan niet garanderen dat je database blijft bestaan, ook als je de browser
verzoekt tijdelijke bestanden op te ruimen.
