...
class Controller.Recipes extends Spine.Controller
    @elements:
        'ul': 'list'
...
class Controller.Recipe extends Spine.Controller
    @elements:
...
class Controller.Fermentables extends Spine.Controller
    @elements:
        'ul': 'list'
        '.template': 'template'
        'h3': 'name'
